...
- 🔭 目前在做：RAG 智能问答系统、抖音视频监控工具、多数据源电商订单自动对账系统
- 🌱 正在学习：LLM 应用开发、RAG 技术、向量数据库
...
| [auto-bill-check](https://github.com/xieyn9988/auto-bill-check) | 多数据源电商订单自动对账系统，支持 MySQL / Excel / CSV 混合对账 | Python, Pandas, SQLAlchemy |
