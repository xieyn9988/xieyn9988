...
| [**auto-bill-check-saas**](https://github.com/xieyn9988/auto-bill-check-saas) 🌟 | **基于 FastAPI + Vue3 + MySQL + Pandas + Docker 的多数据源电商订单自动对账 SaaS 平台**。支持上传 CSV / Excel / TXT 表 / pdf 表，下拉选择 MySQL 表 混合对账，自动识别差异并生成财务可用的 Excel 报表。**Docker 一键部署** | FastAPI, Vue3, MySQL, Pandas, Docker |
