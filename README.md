...
| 项目 | 说明 | 技术栈 |
|------|------|--------|
| [**rag-project**](https://github.com/xieyn9988/rag-project) ⭐ | **基于 LangChain + ChromaDB + BGE + DeepSeek 构建的电商客服 RAG 系统**，支持售后政策、商品信息、物流规则的智能问答，回答准确率 92%+，响应时间 < 3s。提供 CLI / Gradio / FastAPI 三种入口，Docker 一键部署。 | Python, LangChain, ChromaDB, FastAPI, Docker |
